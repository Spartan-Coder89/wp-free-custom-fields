...
class WPFCF_Location_Render_Post {
   ...
   */
  function render() {
    $field_groups_ids = $this->wpfcf_configs->get_filtered_fields_settings_config( 'post-type', $this->post_type );
    $metaboxes_args = $this->setup_metaboxes_args( $field_groups_ids, $this->post_type );
